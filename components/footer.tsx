                ...
                <ul>
                  <li>
                    <a href="#" className="payment-link">
                      <img src="/images/card1.jpg" width="51" height="36" alt="" />
                    </a>
                  </li>
                  <li>
                    <a href="#" className="payment-link">
                      <img src="/images/card2.jpg" width="51" height="36" alt="" />
                    </a>
                  </li>
                  <li>
                    <a href="#" className="payment-link">
                      <img src="/images/card3.jpg" width="51" height="36" alt="" />
                    </a>
                  </li>
                  <li>
                    <a href="#" className="payment-link">
                      <img src="/images/card4.jpg" width="51" height="36" alt="" />
                    </a>
                  </li>
                  <li>
                    <a href="#" className="payment-link">
                      <img src="/images/card5.jpg" width="51" height="36" alt="" />
                    </a>
                  </li>
                </ul>
              </div>
