        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-3 col-md-2 col-md-6 col-xs-6">
              <a href="index-2.html" className="biolife-logo">
                <img src="/images/organic-3.png" alt="biolife logo" width="135" height="34" />
              </a>
            </div>
                            ...
                            <ul className="posts">
                              <li>
                                <div className="block-post-item">
                                  <div className="thumb">
                                    <a href="#">
                                      <img src="/images/megamenu/thumb-05.jpg" width="100" height="73" alt="" />
                                    </a>
                                  </div>
                              ...
                              <li>
                                <div className="block-post-item">
                                  <div className="thumb">
                                    <a href="#">
                                      <img src="/images/megamenu/thumb-06.jpg" width="100" height="73" alt="" />
                                    </a>
                                  </div>
                                  <div className="left-info">
                                    <h4 className="post-name">
                              ...
                              <li>
                                <div className="block-post-item">
                                  <div className="thumb">
                                    <a href="#">
                                      <img src="/images/megamenu/thumb-07.jpg" width="100" height="73" alt="" />
                                    </a>
                                  </div>
                                  <div className="left-info">
                                    <h4 className="post-name">
                        ...
                        <ul className="products">
                          <li>
                            <div className="minicart-item">
                              <div className="thumb">
                                <a href="#">
                                  <img src="/images/minicart/pr-01.jpg" width="90" height="90" alt="National Fresh" />
                                </a>
                              </div>
                              <div className="left-info">
                          ...
                          <li>
                            <div className="minicart-item">
                              <div className="thumb">
                                <a href="#">
                                  <img src="/images/minicart/pr-02.jpg" width="90" height="90" alt="National Fresh" />
                                </a>
                              </div>
                              <div className="left-info">
                                <div className="product-title">
                          ...
                          <li>
                            <div className="minicart-item">
                              <div className="thumb">
                                <a href="#">
                                  <img src="/images/minicart/pr-03.jpg" width="90" height="90" alt="National Fresh" />
                                </a>
                              </div>
                              <div className="left-info">
                                <div className="product-title">
                          ...
                          <li>
                            <div className="minicart-item">
                              <div className="thumb">
                                <a href="#">
                                  <img src="/images/minicart/pr-04.jpg" width="90" height="90" alt="National Fresh" />
                                </a>
                              </div>
                              <div className="left-info">
                                <div className="product-title">
                          ...
                          <li>
                            <div className="minicart-item">
                              <div className="thumb">
                                <a href="#">
                                  <img src="/images/minicart/pr-05.jpg" width="90" height="90" alt="National Fresh" />
                                </a>
                              </div>
                              <div className="left-info">
                                <div className="product-title">
                                ...
                                >
                                    ...
                                    <div className="contain-product none-overlay">
                                      <div className="product-thumb">
                                        <a href="#" className="link-to-product">
                                          <img src="/images/products/p-08.jpg" alt="dd" width="270" height="270" className="product-thumnail" />
                                        </a>
                                      </div>
                                      <div className="info">
                                  ...
                                  <li className="product-item">
                                    <div className="contain-product none-overlay">
                                      <div className="product-thumb">
                                        <a href="#" className="link-to-product">
                                          <img src="/images/products/p-11.jpg" alt="dd" width="270" height="270" className="product-thumnail" />
                                        </a>
                                      </div>
                                      <div className="info">
                                        <b className="categories">Fresh Fruit</b>
                                  ...
                                  <li className="product-item">
                                    <div className="contain-product none-overlay">
                                      <div className="product-thumb">
                                        <a href="#" className="link-to-product">
                                          <img src="/images/products/p-15.jpg" alt="dd" width="270" height="270" className="product-thumnail" />
                                        </a>
                                      </div>
                                      <div className="info">
                                        <b className="categories">Fresh Fruit</b>
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                              <div className="biolife-brand">
                                <ul className="brands">
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/brand-organic.png" width="161" height="136" alt="organic" />
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/brand-explore.png" width="160" height="136" alt="explore" />
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/brand-organic-2.png" width="99" height="136" alt="organic 2" />
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/brand-eco-teas.png" width="164" height="136" alt="eco teas" />
                                    </a>
                                  </li>
                                </ul>
                              </div>
                            ...
                            <div className="col-lg-5 col-md-4 col-sm-12 lg-padding-left-57 md-margin-bottom-30">
                              <div className="biolife-brand vertical md-boder-left-30">
                                ...
                                <ul className="brands">
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/v-brand-organic.png" width="167" height="74" alt="organic" />
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/v-brand-explore.png" width="167" height="72" alt="explore" />
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/v-brand-organic-2.png" width="167" height="99" alt="organic 2" />
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#">
                                      <img src="/images/megamenu/v-brand-eco-teas.png" width="167" height="67" alt="eco teas" />
                                    </a>
                                  </li>
                                </ul>
                              </div>
