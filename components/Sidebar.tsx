  ...
  return (
    <div id="biolife-clone-wrap" className="biolife-clone-wrap">
      ...
      <div className="biolife-panels">
        ...
        {/* 14 */}
        <div id="biolife-panel-12" className="biolife-panel biolife-sub-panel biolife-hidden">
              ...
              <div className="row">
                ...
                <div className="col-lg-6 col-md-4 col-sm-12 lg-padding-left-50 xs-margin-bottom-25 md-margin-bottom-0">
                  <div className="biolife-products-block max-width-270">
                    ...
                    <ul
                      className="products-list default-product-style biolife-carousel nav-none-after-1k2 nav-center slick-initialized slick-slider"
                    ...
                    >
                      <div className="slick-list draggable">
                        <div className="slick-track" style={{ opacity: '1', width: '900px', transform: 'translate3d(0px, 0px, 0px)' }}>
                          <li
                            className="product-item first-slick last-slick slick-slide slick-current slick-active"
                            style={{ marginRight: '30px', width: '270px' }}
                            tabIndex={0}
                            data-slick-index="0"
                            aria-hidden="false"
                          >
                            <div className="contain-product none-overlay">
                              ...
                              <div className="info">
                                ...
                                <h4 className="product-title">
                                  <a href="#" className="pr-name" tabIndex={0}>
                          ...
                          <li
                            className="product-item slick-slide"
                            style={{ marginRight: '30px', width: '270px' }}
                            tabIndex={-1}
                            data-slick-index="1"
                            aria-hidden="true"
                          >
                            <div className="contain-product none-overlay">
                              ...
                              <div className="info">
                                <b className="categories">Fresh Fruit</b>
                                <h4 className="product-title">
                                  <a href="#" className="pr-name" tabIndex={-1}>
                                    National Fresh Fruit
                                  </a>
                                </h4>
                                <div className="price">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                  <div className="biolife-brand">
                    <ul className="brands">
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/brand-organic.png" alt="organic" width="161" height="136" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/brand-explore.png" alt="explore" width="160" height="136" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/brand-organic-2.png" alt="organic 2" width="99" height="136" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/brand-eco-teas.png" alt="eco teas" width="164" height="136" />
                        </a>
                      </li>
                    </ul>
                  </div>
        ...
        {/* 15 */}
        <div id="biolife-panel-13" className="biolife-panel biolife-sub-panel biolife-hidden" data-parent-panel="biolife-main-panel">
                ...
                <div className="col-lg-5 col-md-4 col-sm-12 lg-padding-left-57 md-margin-bottom-30">
                  <div className="biolife-brand vertical md-boder-left-30">
                    ...
                    <ul className="brands">
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/v-brand-organic.png" alt="organic" width="167" height="74" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/v-brand-explore.png" alt="explore" width="167" height="72" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/v-brand-organic-2.png" alt="organic 2" width="167" height="99" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="assets/images/megamenu/v-brand-eco-teas.png" alt="eco teas" width="167" height="67" />
                        </a>
                      </li>
                    </ul>
                  </div>
        ...
        {/* 16 */}
        <div id="biolife-panel-14" className="biolife-panel biolife-sub-panel biolife-hidden">
        ...
        {/* 18 */}
        <div id="biolife-panel-16" className="biolife-panel biolife-sub-panel biolife-hidden" data-parent-panel="biolife-panel-17">
          <ul className="sub-menu">
            <li className="menu-item clone-menu-item">
              <a href="#">Breakfast Burrito</a>
            </li>
        ...
        {/* 19 */}
        <div id="biolife-panel-17" className="biolife-panel biolife-sub-panel biolife-hidden" data-parent-panel="biolife-main-panel">
          <ul className="sub-menu">
            <li className="menu-item clone-menu-item">
              <a href="#">Omelettes</a>
            </li>
            ...
            <li className="menu-item menu-item-has-children has-child clone-menu-item">
              <a className="biolife-next-panel" href="#biolife-panel-15" data-target="#biolife-panel-15"></a>
              <a href="#" className="menu-name" data-title="Eggs &amp; other considerations">
                Eggs &amp; other considerations
              </a>
            </li>
            ...
            <li className="menu-item menu-item-has-children has-child clone-menu-item">
              <a className="biolife-next-panel" href="#biolife-panel-16" data-target="#biolife-panel-16"></a>
              <a href="#" className="menu-name" data-title="Sides &amp; Extras">
                Sides &amp; Extras
              </a>
            </li>
        ...
        {/* 20 */}
        <div id="biolife-panel-18" className="biolife-panel biolife-sub-panel biolife-hidden"></div>

        {/* 21 */}
        <div id="biolife-panel-19" className="biolife-panel biolife-sub-panel biolife-hidden"></div>
      </div>
    </div>
  );
};
